import { getOkxCredentials, type LineageConfig } from "./config.js";
...
export class LocalVerifier implements PaymentVerifier {
  constructor(private readonly cfg: LineageConfig) {}
  ...
  private async post(
    ...
    try {
      ...
      try {
        ...
        // Settlement treats an unparseable response as ambiguous below.
      }
      return {
        kind: "response",
        ok: response.ok,
 ...
 */
export function getVerifier(cfg: LineageConfig): PaymentVerifier {
