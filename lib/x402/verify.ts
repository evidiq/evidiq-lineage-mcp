...
import { z } from "zod";
import type { LineageConfig } from "./config.js";
import type {
...
/** Decode a base64 JSON x402 v2 exact PAYMENT-SIGNATURE envelope. */
...
/** Verify the complete challenge and EIP-3009 typed-data signature locally. */
