/** x402 v2 protocol types used by EVIDIQ Lineage. */
...
/**
 * Decoded PAYMENT-SIGNATURE value. The wire envelope contains a complete
 * `accepted` challenge; scheme and network are also normalized for external
